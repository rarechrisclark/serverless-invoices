<template>
  <footer class="row text-secondary px-0 mt-3 d-print-none">
    ...
    <div class="col-md-8 text-left text-md-right">
      <small v-b-tooltip.hover :title="$t('title')" class="pointer" v-if="!isStorageWordpress">
      ...
      <small class="pl-2">
        ...
        {{ $t("by") }}
        <a href="https://rarechrisclark.com/" class="text-secondary" target="_blank"
          >rareChrisClark</a
        >.
      </small>
      <a
        href="https://github.com/rarechrisclark/serverless-invoices"
